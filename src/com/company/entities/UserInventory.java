...
public class UserInventory {
    ...
    public String toString() {
        return "UserInventory{" +
                "idUserInventory=" + idUserInventory +
                ", lf1=" + lf1 +
                ", mp1=" + mp1 +
                ", lf2=" + lf2 +
                ", lf3=" + lf3 +
    ...
    public int getIdUserInventory() {
        return idUserInventory;
    }

    public void setIdUserInventory(int idUserInventory) {
        this.idUserInventory = idUserInventory;
    }
